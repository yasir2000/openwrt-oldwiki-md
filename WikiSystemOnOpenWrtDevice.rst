...
||[http://didiwiki.org/ DidiWiki] ||C ||Flat files ||libgcc package||No ||Yes ||Works. ||Very small ~25kB and fast. See DidiWiki and BuildingPackagesHowTo for binary link. Runs only on port 8000.  No user authentication.||
