 ...
 * '''[:Gigabit Routers:Gigabit_Routers]''' - Are you looking for a Gigabit router supported by OpenWRT?
...
== Caveats ==
Just because a device is listed doesn't mean that OpenWRT will run on this device. Furthermore, some devices have limited support, while others get by with just the bare minimums. For example, devices with 2mb of flash and 8mb of ram will be able to handle basic tasks only. Quicklinks to manufacturers:
