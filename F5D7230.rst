...
NOTE4: The Siemens SE505 (v2) is nearly exact the same router. It has fewer RAM (8MB) but more flash (4MB). Flashing a Belkin firmware is possible on the Siemens. The LED control is different though.
