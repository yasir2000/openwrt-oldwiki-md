...
this script does the following things:
 ...
 1. it determines my external (wan) IP with a script i got from the openwrt wiki (whatismyip) [http://wiki.openwrt.org/MiniHowtos MiniHowtos Section 3.3]. Instead of hardcoding "vlan1", better to say:
{{{
