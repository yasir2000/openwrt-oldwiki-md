...
== D-Link ==
||'''Model''' ||'''Version''' ||'''Platform & Frequency''' ||'''Flash''' ||'''RAM''' ||'''Wireless NIC''' ||'''Switch''' ||'''boot_wait''' ||'''Serial''' ||'''JTAG''' ||'''USB''' ||'''Status''' ||
||DI-524 ||B2 ||D-Link DL7500A@100MHz (extended real 16bit x86, RDC R2600?) ||1MB ||2MB || Ralink RT25xx ||D-Link DL1005x (IP175x) || || || || ||Unsupported ||
||DI-604 ||Bx,Cx,Dx,Fx ||D-Link DL7x00@100MHz (extended real 16bit x86, RDC R2200?) ||1MB ||2MB || ||D-Link DL1005x (IP175x) || || || || ||Unsupported ||
||DI-704P ||Ax,Bx,Cx,Dx ||D-Link DL7x00@100MHz (extended real 16bit x86, RDC R2200?) ||1MB ||2MB || ||D-Link DL1005x (IP175x) || || || || ||Unsupported ||
||DI-707P ||Ax,Bx,Cx ||D-Link DL7x00@100MHz (extended real 16bit x86, RDC R2200?) ||1MB ||2MB || ||D-Link DL1008x (IP178x) || || || || ||Unsupported ||
