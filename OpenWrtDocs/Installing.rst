...
'''If you have WRT54G v1 and cant get tftp to work try uploading the original firmware then from the webpage on that (192.168.1.1) upload the OpenWrt firmware. ''' 
