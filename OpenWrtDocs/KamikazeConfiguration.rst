...
config wifi-iface
       ...
       option key      encryption key or radius shared secret, when used for wep if you only use one key it can be placed here otherwise set this to the number of keys you would like to use and use the following key1-4 options
