...
There is a debug console which can be reached by pressing the reset when you start de device and then pressing the reset three times after that. (tnx equinoxe for that tip)
