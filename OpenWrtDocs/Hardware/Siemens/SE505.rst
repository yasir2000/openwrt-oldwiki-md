...
- add U981 with an LM7805 (TO220 w/ pin 2 bended to the back side will work)

This will add the +5 Volt supply for the USB-Port.

Go to the other side of the PCB where the antenna is placed.

- add a wire to F51 in place of a fuse (or use a 500mA polyfuse)

- add two resistors of 15k to R723 and R724

- shorten R733 R734 (or use 22R - 33R instead)

- put a USB-Plug to J51 ( reichelt.de )

That's all.

Software side: Installing USB support is simple. Note that the SE505V2 has an OHCI controller.
