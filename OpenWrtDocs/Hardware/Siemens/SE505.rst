...
As of Whiterussian RC6 there is no working hardware detection for SE505V2. A patch to diag.c is necessary (contact any member of the developers, who failed so far to integrate even the most basic support for SE505V2 into the RC6 diag module, or check this link: https://dev.openwrt.org/ticket/1100 ).
