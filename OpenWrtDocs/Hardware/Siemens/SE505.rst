...
If you are running White Russian, you can also use rwflash.o and the mtd-package (the one that comes with WR does NOT work) to flash the cfe from the running system. But be careful: If something goes wrong you will need JTAG.
