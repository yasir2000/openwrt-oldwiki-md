...
The reset button is hard wired to the CPU reset generator chip (7703I) by a capacitor. By removing this capacitor entering failsafe mode, as well as running scripts in /etc/hotplug.d/buttons is possible.
