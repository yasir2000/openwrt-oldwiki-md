...
Thanks to the efforts of Funnel a new CFE is available, that solves this problem! See the forum thread for details: http://forum.openwrt.org/viewtopic.php?id=9379 
...
Sources for RAMs: 
4x16MB: desoldered chips from SE505V2 router ;-)
8x16MB: 64MB SDRAM PC133 SODIMMs w/ 4 chips
16x16MB: 128MB SDRAM PC133 SODIMMs or DIMMs w/ 4 chips
The RAM chips of some SODIMMs or DIMMs with 8 chips may have the right properties, too. But using chips from a 4 chip SDRAM module is the safest option. Check the datasheet if in doubt!
...
Software side: Installing USB kernel modules is simple, just follow the steps described in UsbStorageHowto. Note that the SE505V2 has an OHCI controller.
