...
At 15/06/2007 build '--to' key of iptables'es DNAT isn't work, i tried minimal firmware configuration, or all packages option, or handy set all of iptables exctensions, and it's never happyness.
