...
The ADSL modem is currently not supported with a GPL'ed kernel module.     Apparently there should be a closed source module available, but I haven't tried this yet.
