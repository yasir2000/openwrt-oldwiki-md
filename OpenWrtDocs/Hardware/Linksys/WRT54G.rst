...
||WRT54G v2.2 ||CDF7 || (./) || (./) ||
||WRT54G v3 ||CDF8 || (./) || (./) ||
||WRT54G v3.1 (AU?, DE, FR, UK and SE) ||CDF9 || (./) || (./) ||
||WRT54G v4 ||CDFA || (./) || (./) ||
||WRT54G v5 * ||CDFB || {X} || {X} ||
...
||WRT54G v2.0 ||0x10 ||0x0101 ||0x0188, 0x0388 ||0 ||42 ||7 ||BCM3302 V0.7 ||v2.1, v2.3 ||3.51.21.0 ||
...
||WRT54G v8.0 ||0x10 ||0x048e ||0x750 ||0 ||42 ||-- ||BCM3302 V2.9 ||-- ||-- ||
...
/!\ '''NOTE:''' However, there are no guaranties that these will work, and changing the memory configuration on a non-XH/XB unit with 32 MB of memory will give you a brick.

For an XB card : http://www.dd-wrt.com/phpBB2/viewtopic.php?p=69178#69178

For an XH card : http://forum.openwrt.org/viewtopic.php?pid=7726
...
Check the [:OpenWrtDocs/KamikazeConfiguration#head-02bde9a3b9533ae17cceb41d3f33856bac23a1a1: Kamikaze Configuration] for a script to disable and enable Wifi with a push of a button, and [:OpenWrtDocs/Customizing/Software/WifiToggle: Wifi toggle] for details on other uses.
