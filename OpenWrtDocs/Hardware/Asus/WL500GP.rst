 ...
 * Create the backup with 'sh /tmp/harddisk/part0/asus.sh /tmp/harddisk/part0'. Enter the dd command in the System Command textfield and hit the Refresh button
