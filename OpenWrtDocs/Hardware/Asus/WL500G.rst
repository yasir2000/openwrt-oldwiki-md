...
Note that the internal switch can not be configured through OpenWRT yet because its internally accessed using a GPIO interface instead of MII ([https://dev.openwrt.org/ticket/2064 Source]).
