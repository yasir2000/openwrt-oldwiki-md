...
#staging_dir_mipsel/bin/trx -o ~/wl500w-openwrt.trx \
                    ...
                    -f /tmp/squashfs}}}
7.  If all is well in the world (ie you didn't make any typos) you should now have a new custom made wl500w image sitting in your home directory waiting for you.

8. Unplug router, replug it in while holding in the black reset button. Watch for a slowly blinking power light. The remainder of the TFTP process is described here: OpenWrtViaTftp

9.  Make a kamikaze, drink, enjoy.
