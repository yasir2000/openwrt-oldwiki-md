...
I recommend using the snapshot from x-wrt. The network settings work out of the box so step 2 isn't necessary. (Also seems to fix [http://forum.openwrt.org/viewtopic.php?id=11189 this bug] when using a USB disk)
