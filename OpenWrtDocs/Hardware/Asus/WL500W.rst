...
N mode wireless is not functional at this time as far as I could ascertain (802.11n laptop connects at only 54 Mbit/s).
...
== Stock Firmware ==
'''1.''' Connect to the router with a ethernet cable and tftp over the brcm-2.4 image to the router.
Use the Broadcom 2.4 image:

http://downloads.openwrt.org/kamikaze/7.09/brcm-2.4/openwrt-brcm-2.4-squashfs.trx

Or the one provided by x-wrt if you want webif:
...
'''3.''' Use ipkg to install the memo wireless driver
