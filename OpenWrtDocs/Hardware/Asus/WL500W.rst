...
F.Y.I. about the network interfaces:
...
WL-500W from linux point of view has three interfaces, eth0, eth1, eth2 where:
 ...
 You should configure switch to have no VLANs, but current Kamikaze version unable to do this. Thus, you configure switch to have all ports untagged and placed to same VLAN (for instance VLAN0).
