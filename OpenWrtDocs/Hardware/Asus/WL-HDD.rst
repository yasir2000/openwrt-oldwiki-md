...
USB: 1x USB 1.1, second port possible (see "Second USB Port" on this page)
...
=== JTAG ===
http://www.steve-m.de/wlan/asus_wlhdd_jtag.jpg
...
See the [:OpenWrtDocs/Hardware/Asus/WL-HDD/usb mod:usb_mod photos] with the details.
