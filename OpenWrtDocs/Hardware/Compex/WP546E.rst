...
|| * Pre-Loaded with Compex firmware but already support Open-WRT with easy method of converting to Open-WRT'' (WP54-6E).''
 * Open-WRT preloaded on the board is possible.
 * Serial Ports is soldered onto the board.
 * JTAG Ports is soldered onto the board.
 * JTAG Programmer and Serial Converter are available if you purchase the development kit.
||
