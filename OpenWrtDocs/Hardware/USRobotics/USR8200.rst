...
[http://wiki.openwrt.org/OpenWrtDocs/Hardware/Actiontec/MI424-WR MI424-WR]  Jose Vasconcellos' jungo-image.py to create my backup. It can do more than make the backup... but at the time, my tftp server was not responding to anything. It does have some literals in it you may need to change to match your network setup. The hardware in the MI424-WR has 8MB of flash, and 32MB of RAM... so it must be adjusted to match the properties of the USR8200.
