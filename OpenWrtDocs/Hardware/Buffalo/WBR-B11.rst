...
Where do we start. the TFTP firmware upgrade did not work for me with the openwrt-brcm-2.4-squashfs.trx as it was described to work for the["http://wiki.openwrt.org/OpenWrtDocs/Hardware/Buffalo/WBR2-G54"]. The update through the Webinterface of the WBR-B11 Firmware 1.20 didn't work either. It was throwing me a red AN  ERROR HAS OCCURED DURING FIRMWARE UPLOAD. DEVICE REBOOTING message. Yay I though. Did the bin upload for the WRT54g SquashFS bin, renamed the trx to bin and tried that. No change. So ... thanx to [mbm] who just told me to compare the original firmware header to the trx one. (Could have been my idea *g*)
...
The DIAG light will blink, turn off and turn on again. It took like a minute or so for the WBR-B11 to completely reboot. Gave it another minute or so and then opened["http://192.168.11.1"]. Welcome to OpenWRT RC5.
