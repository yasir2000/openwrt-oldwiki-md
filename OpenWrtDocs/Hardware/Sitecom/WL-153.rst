...
||<tablewidth="410px" tableheight="92px" tablealign="">Amount||Type||
...
||<tablewidth="410px" tableheight="129px" tablealign="">Amount||Type ||
||1||MX29LV160BBTC-70||
||1||RT2661T ||
||1||RTL83055C||
...
Execute a Linux image
 ...
 . linux [-w timeout] [-b <base address> [-l <image length>]]
  . [-r <ramdisk addr> [-s <ramdisk length>]] [-c "kernel command line"]
Load a file
...
ipt_recent v0.2.3: Stephen Frost <>.
ipt_time loading
...
*RT61*<7>E2PROM: G Tssi = 255 255 255 255 - 255 -255 255 255 255, step=255, tuning=0
*RT61*<7>E2PROM: A Tssi = 255 255 255 255 - 255 -255 255 255 255, step=255, tuning=0
