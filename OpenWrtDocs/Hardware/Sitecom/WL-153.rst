...
The external power adapter supplies 12V, 1000 mA DC.
...
If you start HairyDairyMaid's tool with /instrlen:4 it displays a CPU ID which seems to be reasonable (0x3BFFFFDB)
