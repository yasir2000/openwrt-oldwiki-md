...
If wget2nand does not work and gives you a "Cannot find NAND Flash partitions" error:
...
You might need to format the flash from the BIOS and then do the extractions [http://rb1xx.ozo.com/doku.php#quick_howto manually]:
(I did not need to install the RedBoot version mentioned on that page.)
