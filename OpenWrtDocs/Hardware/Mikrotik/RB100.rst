...
Installing OpenWrt on these boards (apart from the 153) is only possible by using the NetBoot facility.  For this you will need:
 ...
 1. A TFTPD server to supply the NetBoot image to load a barebone Kamikaze RAMdisk image.  You will boot into the RAMdisk version of Kamikaze and use it to flash the permanent Kamikaze image into NAND.
 1. A Web server to serve up the permanent version of the Kamikaze kernal and rootfs.
