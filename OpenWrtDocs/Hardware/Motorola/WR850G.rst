...
Date 05/04[[BR]]
[[BR]]
With the version 4.03 the '''control''' page has an option '''upgrade firmware'''. I tried this and it complained that the openwrt-wr850g-squashfs.bin file was not a trx file. I renamed the file and it uploaded. After the upload the modem light blinked red for about a minute. [[BR]]
...
du -s reports
 * 19,788
So I'm guessing it has 16Meg of Ram
