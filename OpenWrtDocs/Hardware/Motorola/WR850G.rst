...
Note: In at least one (feagle814's) WR850G v2, there is only 16mb of RAM onboard.  DO NOT try the 32mb enablement hack on the WR850G v2 without first verifying how much RAM you have!  Failure to verify may cause your router to brick, requiring a JTAG nvram erasure to fix.  Also note that the CFE will report 32mb available on a v2 even if it's not available!
