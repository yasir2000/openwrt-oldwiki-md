...
== WR850G ==
 * gpio 7 controls the "Wireless" "green" light (0=off, 1=on)
 * gpio 6 controls the "Modem" "green" light (0=on, 1=off)
 * gpio 5 controls the "Wireless" "red" light (0=off, 1=on)
 * gpio 4 controls the "Power" "green" light (0=on, 1=off)
 * gpio 3 controls the "Power" "red flashing" light (0=off, 1=on/flashing)
 * gpio 2 unknown (possibly 4port switch LEDs, 1turns all on)
 * gpio 1 uart interrupt (if connected)
