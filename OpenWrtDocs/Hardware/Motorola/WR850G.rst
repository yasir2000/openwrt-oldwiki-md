...
ISSI IS42S16400B1-7T is a 16MB chip.  Your router may have two of these (check the bottom of the PCB for the second one.)  If you have two you have a 32MB model.
