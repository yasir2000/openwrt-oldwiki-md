...
== Possible Alternate loading method ==
*** This method has '''NOT''' been shown to work yet ** [[BR]]
...
Date 05/04[[BR]]
[[BR]]
With the version 4.03 the control page has an option '''upgrade firmware'''. I tried this and it complained that the openwrt-wr850g-squashfs.bin file was not a trx file. I renamed the file and it uploaded. After the upload the modem light blinked red for about a minute. I have not been able to find the IP for the device since, however it took me quite a while to find it in the first place. I have etheral protocol analyzer running and am only seeing spanning tree protocol messages from the ethernet address and about every fourth message is a ppoe query. I can't find the IP address of the router yet. Has anyone had success or failure with this method? [[BR]] [[BR]]
Further... I followed the Motorola instructions and unplugged the device and went and made tea. When I plugged it back in, I put into a different pc and using the original IP address in the brower pulled up the openwrt welcome page. BINGO and a lot easier. [[BR]]
