...
/!\ It is adviced not to use RC5 for WE800G https://dev.openwrt.org/ticket/504 (The same is with 0.9 https://dev.openwrt.org/ticket/1337 )! Use the pre-RC5 or RC6 image.
 ...
 * Only starting the repeated pressing of the reset button as soon as the device is connected to the mains will help you into the failsafe mode. Just try to telnet into 192.168.1.1.
