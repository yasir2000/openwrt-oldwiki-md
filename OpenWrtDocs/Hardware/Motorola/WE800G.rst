...
= Flashing to OpenWRT =
Imre Kaloz has made a test [http://downloads.openwrt.org/people/kaloz/openwrt-we800g.bin image] of WHITE RUSSIAN (RC4). Note: NBD more recent snapshots are working as well [http://downloads.openwrt.org/people/nbd/whiterussian/].
