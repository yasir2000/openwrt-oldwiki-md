...
Note: There is no WAN interface, use WIFI instead (wifi_ipaddr; wifi_netmask; wifi_proto; ... [:OpenWrtNVRAM: variables]).
...
Note2: There is no WAN interface, you have to set LAN parameters (lan_ipaddr; lan_netmask; lan_proto; ... [:OpenWrtNVRAM: variables]).
...
Note: There is no WAN interface, you have to set LAN parameters (lan_ipaddr; lan_netmask; lan_proto; ... [:OpenWrtNVRAM: variables]).
