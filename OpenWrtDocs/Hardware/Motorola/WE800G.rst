...
I think I have the version 2.   I cannot see any different outside and inside.  It also has the same mini-PCI card; however, It only has 2Mb flash and 8Mb SDRAM. It is not that useful even using the micro version of OpenWRT.
