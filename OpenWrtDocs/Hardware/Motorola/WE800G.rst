...
== Bridged Client Mode ==
To put the WE800G into the bridged client mode you have to bridge LAN and WLAN port, disable separate wifi device and put the radio into WET mode. [http://woz.gs/wifi/openwrtbridge.html]
