...
----------------------------------------------------------------------------------------
| 0x1E0000 | 0xBFDE0000 |   64 kb |      1 | NVRam                                     |
----------------------------------------------------------------------------------------
| 0x1F0000 | 0xBFDF0000 |   64 kb |      1 | Radio Config                              |
----------------------------------------------------------------------------------------
...
Note: we can do a reboot in PMon by issuing a "go" command, address is the
location of the bootloader in flash:
