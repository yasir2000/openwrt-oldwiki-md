...
== Serial Port ==
The RS232 port is using 3.3V TTL signals, we have to use a level shifter like the Maxim Max232. In addition i'm using a RS232<->USB converter to connect it to my PC (linux+minicom).
