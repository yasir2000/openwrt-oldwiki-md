...
A photo can be found [http://www.wireless-forum.ch/forum/files/netgear_wgt624_platine.jpg here].

== Specs for WGT624v2 ==
 * FCC ID: PY3WGR614v3
 * internal label: U12H018, REV.1
 * CPU: Atheros AR2313A
 * Flash: MX 29LV160BTTC-90 (2MByte)
 * RAM: Winbond W981216DH-75 (16 MByte)
 * Switch: Marvell 88E6060-RCJ
 * one external fixed antenna, one antenna on the PCB
 * Powersupply: 12V/1A

The PCB layout [http://www.embraceit.com.au/wgt624/ here] resembles the one of a WGT624v2 (it's got a step-down converter close to the antenna compared to v1).

== WGT624v3 ==

See [http://forum.openwrt.org/viewtopic.php?id=13455 this thread] for some pictures of the WGT624v3. Seems like the flash is a serial one, no a parallel as used in v1 and v2.
