...
mips-linux-ld -G 0 -static -n -T arch/mips/ld.script arch/mips/kernel/head.o arch/mips/kernel/init_task.o init/main.o init/version.o init/do_mounts.o \
        ...
        --end-group \
        -o vmlinux
drivers/mtd/mtdlink.o: In function `jedec_probe':
jedec.c:(.text+0x13a18): undefined reference to `strcpy'
jedec.c:(.text+0x13a18): relocation truncated to fit: R_MIPS_26 against `strcpy'
