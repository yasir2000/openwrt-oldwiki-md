...
The WGT634U is based on the Broadcom 5365P board that features a 200 MHz MIPS CPU along with a builtin IPSEC co-processor, allowing encrypted VPN's (up to AES256 IPSec) a bonus of a perfomance boost upto 75Mbps (quoted) IPSec throughput - far more than the MIPS32 CPU alone can produce.  It also comes standard with 8 MB flash and 32 MB RAM.
