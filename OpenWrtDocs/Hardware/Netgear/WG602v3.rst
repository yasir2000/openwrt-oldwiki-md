...
=== Kamikaze ===
As of revision 3586, Kamikaze appears to be basically working except for /sbin/ifconfig. 
If you remove it from your root image, Kamikaze will boot without issues through the kernel, init, to a working shell.
