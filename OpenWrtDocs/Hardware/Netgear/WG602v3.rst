...
=== Kamikaze ===
As of revision 3586, Kamikaze appears to be basically working except for /sbin/ifconfig.  If you remove it from your root image, Kamikaze will boot without issues through the kernel, init, to a working shell.
...
Primary instruction cache 16kB, physically tagged, 2-way, linesize 16 bytes.
Primary data cache 8kB, 2-way, linesize 16 bytes.
Linux version 2.4.32 (fwyzard@grid006.fi.infn.it) (gcc version 3.4.4 (OpenWrt-2.0)) #3 Wed Apr 5 13:50:06 CEST 2006
...
init started:  BusyBox v1.1.1 (2006.04.04-16:53+0000) multi-call binary

Please press Enter to activate this console. jffs2.bbc: SIZE compression mode activated.



BusyBox v1.1.1 (2006.04.04-16:53+0000) Built-in shell (ash)
...
Running {{{/sbin/ifconfig}}} will give a bus error the 1st time, and lock the system the 2nd time:

 . {{{
root@OpenWrt:/# /rom/sbin/ifconfig eth0 up 192.168.0.227 mask 255.255.255.0
Data bus error, epc == 800ab9b4, ra == 800aba90
Oops in traps.c::do_be, line 385:
$0 : 00000000 1000fc00 00060000 000f3800 b8001428 00068db9 80000000 00000064
$8 : 00000000 00000001 00000001 80196e50 0000032d 1000fc00 00000000 00000001
$16: 80763d60 00000100 80763c00 80763d60 80441eb0 00000000 00000000 00008914
$24: ba2e8ba3 801a25d4                   80440000 80441da0 7fff7c38 800aba90
Hi : 00000000
Lo : 00000000
...
Cause : 0000801c
PrId  : 00029008
Process ifconfig (pid: 353, stackpage=80440000)
Stack:    800c5f94 00000000 00000001 00000000 00000001 00008914 800ad47c
 ...
 00008914 00000001 80763d60 80763d60 00000000 80763c00 00000000 80441eb0
 800ad870 0000009a 80028300 80763d60 00000000 80763d60 00000000 80763d60
 800adfa4 00000004 0049acb0 805332c0 801f8034 80763c00 0049acb0 80763c00
 00000000 ...
