...
How to upload a firmware via TFTP:
 ...
 1. tftp to the box; set binary mode; and upload the firmare file as image.idts334 . You have a very limited time to do this, so it may actually work better to first issue the tftp command, and then reboot the AP.
