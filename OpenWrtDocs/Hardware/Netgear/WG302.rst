 ...
 *write microcode to flash. Attention: Be sure to specify the corrent startaddress 0x50780000=startaddress of root partition plus size of root partition, as redboot otherwise places the microcode within the root partition. Bug or feature?
{{{
