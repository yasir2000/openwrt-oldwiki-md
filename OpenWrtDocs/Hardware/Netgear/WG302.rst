...
0x00160000-0x00240000 : "rootfs"
0x00220000-0x00240000 : "rootfs_data"
0x00240000-0x007c0000 : "unallocated"
...
= Open Issues =
 *Kamikaze 7.06 is not able to create the jffs2 filesystem rootfs_data properly:
{{{
- preinit -
switching to jffs2
jffs2: Too few erase blocks (1)
...
jffs2: Too few erase blocks (1)
 ...
 Reason for that (compare http://wiki.openwrt.org/OpenWrtDocs/Hardware/Meraki/Mini): rootfs_data fills the rear end of the rootfs mtd partition, but we create the rootfs partition just as big as the squashfs image size. We need some magic options in the fis create command to create a bigger partition than the size of the squashfs.
