...
ifconfig: SIOCSIFFLAGS: Input/output error
 ...
 Worksround: After Boot, enter dd if=/dev/mtdblock4 of=/dev/ixp4xx_ucode bs=11964 count=1         (assuming, that you have created the microcode partition as outlined above)
