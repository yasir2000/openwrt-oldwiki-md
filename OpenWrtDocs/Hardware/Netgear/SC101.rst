...
The original SC101 prototype design did have an external fan mounted on the back end of the unit, which was removed on some devices went into production.
