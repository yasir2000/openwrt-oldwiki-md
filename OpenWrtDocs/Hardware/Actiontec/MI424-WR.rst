...
The openwrt images were built with the following configuration files: attachment:openwrt.config and attachment:kernel.config . Here's a boot log generated by dmesg:
