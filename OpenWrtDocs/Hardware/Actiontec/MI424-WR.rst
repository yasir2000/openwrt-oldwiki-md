...
== Software ==
=== RedBoot ===
A custom version of RedBoot has been built and can be found [javascript:void(0);/*1220019082254*/ here]. The redboot prompt is accessible via {{{telnet 192.168.1.1 9000}}} on the Wan port.

=== Linux ===
Board id 1778 has been registered for this device. Here's a boot log generated by dmesg:
...
=== TODO ===
 * Fix mac address [javascript:void(0);/*1220018764735*/ issue].
