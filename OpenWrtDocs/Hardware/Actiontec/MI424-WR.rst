...
=== Linux ===
Board id 1778 has been registered for this device. When building OpenWrt from source, you'll need the MI424-WR patch that can be found [http://mysite.verizon.net/jvasco/mi424wr/333-mi424wr_support.patch here] and should be copied to the {{{target/linux/ixp4xx/patches/2.6.26}}} directory. Also, target profile should be set to MI424WR; this brings in the necessary modules such spi-ks8995 and rt2500pci.
