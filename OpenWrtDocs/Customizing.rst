 ...
 * ["/Hardware/JTAG Cable"] Howto create a JTAG cable to revive a WRT
 * ["/Hardware/Serial Console"] Howto attach a serial console via usb or parallel port to your wrt
 ...
 * ["/Hardware/Power over Ethernet"] Power Over Ethernet/Power Requirements
 ...
 * ["/Hardware/I2C RTC"] add an I2C bus a Real Time Clock
 * ["/Hardware/RAM upgrade"] (WRT54GL) replace the RAM chip to allow for 64MB memory
= Software =
 * Networking
  ...
  * [http://www.hetos.de/bwlog.html DHCP Notify] A tweak to get your router to notify you of any changes in DHCP Leases (add/del). Never miss again an un-wanted client that connects to your network.
= Firmware =
