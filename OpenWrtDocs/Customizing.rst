...
With my Linksys WRT54G2 I downloaded first my complet nvram to my desktop computer. I try to overclock with clkfreq=216. I realized that the router make booting again and again. But I managed to debrick it. I unplug the power supply of the route, press and hold down the reset button then plug in. In the next seconds the nvram will be erased and fill up with default settings. My router boots after normally. After all I have to do only to set up the original nvram settings from my downloaded one.
