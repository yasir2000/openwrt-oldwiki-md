 ...
 * Networking
  ...
  * [http://www.hetos.de/bwlog.html DHCP Notify] A tweak to get your router to notify you of any changes in DHCP Leases (add/del).
Never miss again an un-wanted client that connects to your network.
= Firmware =
