...
'''Hint:''' Currently the driver loads but both streaming programms still do not work. Spook is on the way, wis-streamer causes a segfault and will even crash the modules with a kernel oops. We are working on it...
